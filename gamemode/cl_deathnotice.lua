...
killicon.AddFont("weapon_zs_classic", "zsdeathnoticecs", "n", color_white)
killicon.AddFont("weapon_zs_classixx", "zsdeathnoticecs", "n", Color(255,120,233,255))
...
killicon.AddFont("weapon_zs_dual_uzi2", "zsdeathnoticecs", "d", color_white)
...
killicon.AddFont("weapon_zs_dual_deagle", "zsdeathnoticecs", "f", color_white)
...
killicon.AddFont("weapon_zs_mp1", "zsdeathnoticecs", "x", Color(63,0,200))
killicon.AddFont("projectile_mp1_grenade", "zsdeathnoticecs", "4", Color(63,0,200))
killicon.AddFont("weapon_zs_swissarmyknife", "zsdeathnoticecs", "j", color_white)
killicon.AddFont("weapon_zs_cloak_knife", "zsdeathnoticecs", "j", Color(63,0,200))
killicon.AddFont("weapon_zs_sprayersmg", "zsdeathnoticecs", "l", color_white)
killicon.AddFont("weapon_zs_dual_uzi", "zsdeathnoticecs", "l", color_white)
...
killicon.AddFont("weapon_zs_m4_1", "zsdeathnoticecs", "w", Color(63,0,200))
...
killicon.AddFont("weapon_zs_abakan", "zsdeathnoticecs", "b", color_white)
...
killicon.Add("weapon_zs_misericorde", "killicon/weapon_zs_misericorde", color_white)
...
killicon.Add("weapon_zs_bioticpistol", "killicon/weapon_zs_bioticshotgun", color_white)
